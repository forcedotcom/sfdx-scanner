...
public class LanguageXmlFileMapping {
	...
	final private Map<String, Set<String>> categoryPathsByLanguage;
	final private Map<String, Set<String>> rulesetPathsByLanguage;
	final private Map<String, String> categoryToSourceJar;
	final private Map<String, String> rulesetToSourceJar;
