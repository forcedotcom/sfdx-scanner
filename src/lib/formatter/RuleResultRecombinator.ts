...
import {EngineExecutionSummary, ResultTableRow, RecombinedData, RecombinedRuleResults, RuleResult, RuleViolation} from '../../types';
...
const PATHLESS_COLUMNS: Ux.Table.Columns<ResultTableRow> = {
	location: {},
	...BASE_COLUMNS
};
