...
# NOTE: THIS SCRIPT IS A LOCAL VERSION OF https://www.npmjs.com/install.sh, which will be used by CircleCI when upgrading
# node on a linux docker image. Running this script locally is STRONGLY DISCOURAGED. Please don't do it.
