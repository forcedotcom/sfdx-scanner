...
# NOTE: This is a locally copied version of https://www.npmjs.com/install.sh, used by CircleCI when upgrading node on
# a linux Docker image. Running this script locally is STRONGLY DISCOURAGED. Please don't do it.
