...
/** Used when {@link SFVertexFactory} can't find a specific class type to load */
final class DefaultVertex extends BaseSFVertex {
    DefaultVertex(Map<Object, Object> properties) {
        super(properties);
    }
