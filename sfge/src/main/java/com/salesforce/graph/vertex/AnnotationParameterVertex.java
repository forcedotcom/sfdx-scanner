...
public class AnnotationParameterVertex extends BaseSFVertex {
    public AnnotationParameterVertex(Map<Object, Object> properties) {
        super(properties);
    }
    ...
    public Optional<String> getValue() {
        return Optional.ofNullable(getString(Schema.VALUE));
    }
}
