...
public class NewSetLiteralExpressionWrapper extends AstNodeWrapper<NewSetLiteralExpression> {
    NewSetLiteralExpressionWrapper(NewSetLiteralExpression node, AstNodeWrapper<?> parent) {
        super(node, parent);
    }
