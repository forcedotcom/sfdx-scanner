...
public class SimpleCasesTest extends BaseUnusedMethodTest {
    ...
    /**
     * We want public and protected tests for arity of both 0 and 1, but a private test for only the
     * arity 1 constructor, since a private constructor with arity 0 is ineligible.
     */
    // TODO: Enable subsequent tests as we implement functionality.
    @CsvSource({
