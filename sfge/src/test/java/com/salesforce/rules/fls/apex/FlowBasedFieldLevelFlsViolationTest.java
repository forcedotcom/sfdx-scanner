...
public class FlowBasedFieldLevelFlsViolationTest extends BaseFlsTest {
    ...
    public void testReadFirstLevelMethodCallValue() {
        ...
        assertViolations(
            ApexFlsViolationRule.getInstance(),
            sourceCode,
            expect(3, FlsValidationType.READ, "Account").withField("Name"));
    }
    ...
    @Test
    public void testReadSecondLevelMethodCallValue_Variation() {
        String[] sourceCode =
            {
                "public class MyClass {\n" +
                    "   public void foo() {\n" +
                    "       Database.query(newQueryFactory().getQuery());\n" +
                    "   }\n" +
                    "   MyClass newQueryFactory() {\n" +
                    "       return this;\n" +
                    "   }\n" +
                    "   String getQuery() {\n" +
                    "       return 'SELECT Name from Account';" +
    ...
    public void testInsertFirstLevelMethodCallValue() {
        ...
        assertViolations(
            ApexFlsViolationRule.getInstance(),
            sourceCode,
            expect(3, FlsValidationType.INSERT, "Account").withField("Name"));
    }
    ...
    @Test
    public void testUnresolvedMethodCallValue() {
        String sourceCode =
            "public class MyClass {\n" +
                "   public void foo() {\n" +
                "       Database.query(MyStringBuilder.getQuery());\n" +
                "   }\n" +
                "}\n";
        ...
        assertViolations(
            ApexFlsViolationRule.getInstance(),
            sourceCode,
            expectUnresolvedCrudFls(3, FlsValidationType.READ));
    }
}
