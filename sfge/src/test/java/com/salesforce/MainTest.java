...
public class MainTest {
    ...
    void testNoActionProvided() {
        ...
        main.process();
        verify(dependencies).printError(UserFacingMessages.InvocationErrors.REQUIRES_AT_LEAST_ONE_ARGUMENT);
    }
    ...
    void testInvalidActionProvided() {
        ...
        assertThrows(
                ...
                String.format(UserFacingMessages.InvocationErrors.UNRECOGNIZED_ACTION, invalid_action));
    }
