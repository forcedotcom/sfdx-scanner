module.exports = {
	...
	"warning": {
		...
		"langMarkedForDeath": "Future releases will not include PMD support for %s. If this would cause you hardship, please log an issue on github.com/forcedotcom/sfdx-scanner",
