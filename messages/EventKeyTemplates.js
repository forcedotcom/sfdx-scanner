module.exports = {
	...
	"warning": {
		"pmd7IncompatibleRule": "PMD rule [%s] needs the following properties to be compatible with PMD7: [%s]. If adding these properties is non-viable for you, please log an issue on github.com/forcedotcom/sfdx-scanner",
