module.exports = {
	...
	"warning": {
		"pmd7IncompatibleRule": "Please add a `language` property to PMD rule [%s] to ensure compatibility with PMD 7. If this is non-viable for you, please log an issue on github.com/forcedotcom/sfdx-scanner",
