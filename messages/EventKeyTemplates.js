module.exports = {
	...
	"warning": {
		"pmd7IncompatibleRule": "PMD rule [%s] is incompatible with PMD 7: %s. If resolving these problems is non-viable for you, log an issue on github.com/forcedotcom/sfdx-scanner",
