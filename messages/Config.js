module.exports = {
	...
	"InvalidBooleanValue": "Specify a valid property for '%s' in config for %s. Supply a boolean: %s.",
	"InvalidNumberValue": "Specify a valid property for '%s' in config for %s. Supply a number: %s.",
