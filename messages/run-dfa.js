module.exports = {
	...
	"flags": {
		"pathexplimitDescription": "specify upperlimit to which Graph Engine can handle code complexity. Alternatively, set value using environment variable `SFGE_PATH_EXPANSION_LIMIT`",
		"pathexplimitDescriptionLong": "Specifies an upperlimit upto which Graph Engine would handle code complexity before failing fast. Set value to -1 to remove any upper limit. Inherits value from SFGE_PATH_EXPANSION_LIMIT env-var if set. Default value is derived from jvm heap space allocation.",
