module.exports = {
	...
	"flags": {
		...
		"vceParamDeprecationWarning": "--violations-cause-error parameter is being deprecated, use --severity-for-error instead.",
		"sfeDescription": "throws an error when violations of specific severity (or more severe) are detected",
        "sfeDescriptionLong": "Throws an error if violations are found with equal or greater severity than provided value. Values are 1 (high), 2 (moderate), and 3 (low). Exit code is the most severe violation. Using this flag also invokes the --normalize-severity flag",
