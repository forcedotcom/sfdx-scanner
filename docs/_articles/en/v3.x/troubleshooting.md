...
This `LimitReachedError` is a current, known Graph Engine issue. Refer to our [recommendations](./en/v3.x/salesforce-graph-engine/working-with-sfge/#outofmemory-java-heap-space-error) to reduce the probability of experiencing the heap space error.
