...
public enum EventKey {
    ...
    INFO_BEGIN_PATH_CREATION("info.sfgeBeginPathCreation", 0, MessageType.INFO, MessageHandler.UX, true),
    INFO_END_PATH_CREATION("info.sfgeEndPathCreation", 1, MessageType.INFO, MessageHandler.UX, false),
    INFO_PATH_ANALYSIS_PROGRESS("info.sfgePathAnalysisProgress", 2, MessageType.INFO, MessageHandler.UX, true),
